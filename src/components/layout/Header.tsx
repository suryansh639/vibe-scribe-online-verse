      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link to="/" className="flex items-center">
            <img alt="Blog Company" className="h-10" src="/lovable-uploads/3efa0f09-9113-4a2d-8a87-9d8474d73326.png" />
          </Link>
          
          <div className="hidden md:flex items-center relative">
            <Search className="absolute left-3 text-gray-400" size={18} />
            <input type="text" placeholder="Search articles..." className="pl-10 pr-4 py-2 rounded-full bg-gray-100 focus:bg-white border border-gray-200 focus:border-brand-orange focus:outline-none w-64" />
          </div>
        </div>
